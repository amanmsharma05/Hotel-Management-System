...
public class UpdateCheck extends JFrame implements ActionListener{
    ...
    UpdateCheck(){
        ...
        back.setBounds(140,340,100,30);
        add(back);
        
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("icons/icons/nine.jpg"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==check){
            ...
            try{
                Conn c=new Conn();
                c.s.executeUpdate("update customer set roomnumber='"+room+"', check_In_Time='"+checkin+"', deposit='"+deposit+"',name='"+name+"' where number='"+number+"'");//with dml command we use executeUpdate
